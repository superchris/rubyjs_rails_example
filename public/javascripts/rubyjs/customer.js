...
return _tmp_0}catch(_tmp_3){if(_tmp_3 instanceof a$iter_jump && (!_tmp_3.a$scope || _tmp_3.a$scope==26))return _tmp_3.a$return_value;
throw(_tmp_3)}}
...
_tmp_2=_k.$to_json().$___plus(nil,":").$___plus(nil,_v.$to_json());
...
,$___set:
/* DOMElement#[]= */
function(_tmp_1,_attr,_value){var self,_element,_attr_name,_tmp_0;
_tmp_0=nil;
self=this;
if(self.$___ivardom_element==null)self.$___ivardom_element=nil;
try{if(arguments.length!=3)throw($ArgumentError.$new(nil,'wrong number of arguments ('+Math.max(0,arguments.length-1).toString()+' for 2)'));
;
_attr_name=_attr.$to_s();
_element=self.$___ivardom_element;
...
if(arguments.length>1)throw($ArgumentError.$new(nil,'wrong number of arguments ('+Math.max(0,arguments.length-1).toString()+' for 0)'));
;
_tmp_2=self.$map(function(_tmp_0){var _a;
var _tmp_1=nil;
_a=_tmp_0==null?nil:_tmp_0;
_tmp_1=_a.$to_json();
